...
public class DishDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView ivDish = findViewById(R.id.iv_dish);  // Đảm bảo ID khớp XML
        if (ivDish != null && dish != null) {
            loadDishImage(ivDish, dish);  // Gọi method helper dưới
        }
    }
